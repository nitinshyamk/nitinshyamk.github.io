...
summary: We developed a new algorithm to estimate a single element of a sparse linear system in sublinear time by combining a reverse variational technique with forward MCMC sampling.
---
