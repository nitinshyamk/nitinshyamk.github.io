...
summary: Bounding a robust controller's stability radius against model error shows that tolerating more learning error cuts the data required by an order of magnitude while costing under 5% of control performance.
---
