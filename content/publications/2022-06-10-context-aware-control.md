...
summary: We quantified the stability versus learning error tradeoff of a robust H-infinity controller, and showed that tolerating a 5% loss in control objective performance can cut data collection requirements by an order of magnitude.
---
